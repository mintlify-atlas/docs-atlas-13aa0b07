...
description: Complete list of microcontrollers, sensors, displays, and components available in Wokwi
---
...
| **STM32** | [STM32C031](/parts/board-st-nucleo-c031c6), [STM32L031](/parts/board-st-nucleo-l031k6), [STM32F103C8](/parts/board-stm32-bluepill) |
...
| [BMP180](/parts/wokwi-bmp180) | Barometric pressure and temperature sensor with I2C interface |
...
| [SSD1306 OLED](/parts/wokwi-ssd1306) | Monochrome 128x64 OLED display with I2C interface |
...
<Card title="Request a Part" icon="plus" href="https://wokwi.com/discord">
  Don't see the component you need? Join our Discord community to request new parts or create custom components using the Chips API.
</Card>
