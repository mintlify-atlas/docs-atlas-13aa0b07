...
description: Learn how to create custom simulation models and extend Wokwi functionality with the Chips API
---
...
- [Step-by-step blog tutorial](tutorial-7seg) - Create a 7-segment driver chip from scratch
...
![Chips Console](./chips-console.png)
