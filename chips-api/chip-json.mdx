...
description: Define the pinout and properties of custom chips using the Chip Definition JSON format
---
...
To read the value of the control from your chip code, use the [Attributes API](attributes).
...
To draw on the display from your chip code, use the [Framebuffer API](framebuffer).

## JSON Schema

A [JSON Schema](https://github.com/wokwi/wokwi-cli/blob/main/packages/cli/src/chip/chip.schema.json) for validating chip definition files is available in the wokwi-cli repository.
