...
description: Implement SPI peripheral devices in custom chips
---
...
<ParamField path="sck" type="pin_t">
  The clock pin
</ParamField>

<ParamField path="mosi" type="pin_t">
  The MOSI data pin (or `NO_PIN` to disable MOSI)
</ParamField>

<ParamField path="miso" type="pin_t">
...
<ParamField path="done" type="callback">
  Called when an SPI transaction finishes (see below)
</ParamField>
