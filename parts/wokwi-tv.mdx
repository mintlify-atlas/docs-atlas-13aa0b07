---
title: PAL TV Display
description: Black and White analog PAL TV screen
---
...
<ParamField path="IN" type="pin">
  Data (image) signal
</ParamField>

<ParamField path="SYNC" type="pin">
...
We implement a simple voltage divider to generate the required voltages, based on the two digital pin levels:
