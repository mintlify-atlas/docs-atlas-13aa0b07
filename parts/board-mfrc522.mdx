...
description: RFID/NFC reader module with SPI interface for reading 13.56 MHz MIFARE cards and tags
---
...
<ParamField path="RST" type="input">
  Reset (active low)
</ParamField>
...
<ParamField path="IRQ" type="output">
  Interrupt request (active low)
</ParamField>

<ParamField path="MISO" type="spi">
  SPI data out
</ParamField>

<ParamField path="MOSI" type="spi">
  SPI data in
</ParamField>

<ParamField path="SCK" type="spi">
  SPI clock
</ParamField>

<ParamField path="SDA" type="spi">
