...
description: 38KHz infrared remote with 20 function keys
---

38KHz infrared remote with 20 function keys. Use together with the [IR Receiver module](/parts/wokwi-ir-receiver).
