...
description: RTC (Real Time Clock) module with I2C interface and 56 bytes of NV SRAM
---
...
<ParamField path="SQW" type="output">
  Square wave output
</ParamField>
...
<ParamField path="initTime" type="string" default="now">
