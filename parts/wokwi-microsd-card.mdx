---
title: microSD Card
description: microSD card with SPI interface and FAT16 filesystem support
---
...
<ParamField path="CD" type="detect">
...
<ParamField path="DI" type="spi">
  SPI data input (MOSI)
</ParamField>

<ParamField path="CS" type="spi">
  Chip select
</ParamField>
