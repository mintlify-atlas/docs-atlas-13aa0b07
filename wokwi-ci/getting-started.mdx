...
<CardGroup cols={2}>
  <Card title="Install the Wokwi CLI" href="./cli-installation" icon="download">
    Run your firmware on your local machine or CI system
  </Card>
  <Card title="Write Automation Scenarios" href="./automation-scenarios" icon="play">
    Automate the simulation and test your firmware
  </Card>
  <Card title="Use Wokwi with GitHub Actions" href="./github-actions" icon="github">
    Run your tests on every commit
  </Card>
  <Card title="Set up MCP Support" href="./mcp-support" icon="robot">
    Integrate Wokwi with AI agents
  </Card>
</CardGroup>

<Tip>
Check out the [example projects](./github-actions#examples) that are set up to run on Wokwi CI, or [join the Wokwi Discord server](https://wokwi.com/discord) to get help and share your projects with the community.
</Tip>
