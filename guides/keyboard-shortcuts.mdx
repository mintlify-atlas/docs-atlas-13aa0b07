...
description: Master Wokwi's keyboard shortcuts for simulation, code editing, and power editing operations.
---
...
| Duplicate line\* above                  | <kbd>Alt</kbd> + <kbd>Shift</kbd> + <kbd>Up</kbd>   | <kbd>⌥</kbd> + <kbd>⇧</kbd> + <kbd>Up</kbd>    |
